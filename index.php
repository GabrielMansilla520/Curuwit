    ...
    <main>
      <div class="container-fluid bg-light">
        <div
          ...
          style="height: 100vh"
        >
          <div class="col-md-4 mx-auto mb-4 mb-sm-0 headline text-center">
            <span class="text-secondary text-uppercase"
              >Siempre conectados</span
            >
            <h1 class="display-4 my-4 font-weight-bold">
              Bienvenido a <span style="color: #9b5de5">CuruWit</span>
            </h1>
            <a
              href="./assets/php/register.php"
              class="btn px-4 py-3 text-white mt-3 mt-sm-0"
